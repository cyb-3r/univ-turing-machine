def question_7(path: str):
    ...
    while i<t:
        ...
        if lines[i][0:4] == "init":
            ...
            i += 1
        elif lines[i][0:2] == "//" or lines[i][0:4] == "name" or lines[i] == "" or lines[i][0] == "\n":
            i += 1
            pass
        else:
...
def question_9(code: str, mot, str):
    r1 = code
    r2 = "0"
    r3 = mot
    p1 = 0
